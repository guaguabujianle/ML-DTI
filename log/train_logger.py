...
class TrainLogger(BasicLogger):
    def __init__(self, args):
        ...
        if args.get('mark') == None:
            savetag = timestamp + '_' + args.get('model') + '_' + args.get('dataset') + '_' + args.get('split_type') + '_' + str(args.get('fold'))
        else:
            savetag = timestamp + '_' + args.get('model') + '_' + args.get('dataset') + '_' + args.get('split_type') + '_' + str(args.get('fold')) + '_' + args.get('mark')
